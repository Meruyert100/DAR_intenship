...
struct Post {
    ...
    static func fetchPosts() -> [Post] {
        ...
        let post2 = Post(createdBy: user2, caption: "When you work on any thing that matters, it's ok to worry, fear, and be uncomfortable. Just never give up!", image: UIImage(named: "1"), numberOfLikes: 113, timeAgo: "3 hrs ago")
        
        let user3 = User(avatar: UIImage(imageLiteralResourceName: "margaret"), username: "margo")
        let post3 = Post(createdBy: user3, caption: "Hello!", image: UIImage(named: "2"), numberOfLikes: 8, timeAgo: "5 hrs ago")
